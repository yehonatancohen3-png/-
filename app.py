...
* הצג תשובה מלאה, שיטתית ומקיפה המחולקת וממוספרת במדויק לפי 6 הסעיפים:
  1. פסוקים (אם יש בסוגיה)
  2. מקור בגמרא (ומדרשי הלכה)
  3. שיטות הראשונים (רש"י, תוספות, רמב"ם וכו')
  4. פסק השולחן ערוך והרמ"א
  5. אחרונים ונושאי כלים
  6. הלכה למעשה (פירוט מפורש לפי מנהגי עדות: אשכנז, ספרד, ותימן)
* ציטוטים מהמקורות הבא בתוך מרכאות אות-באות מתוך המקורות שנשלפו.
* חובה לסיים כל תשובה במשפט: "הערה: תוכן זה מיועד ללימוד בלבד, ואין לפסוק ממנו הלכה למעשה."
""",
